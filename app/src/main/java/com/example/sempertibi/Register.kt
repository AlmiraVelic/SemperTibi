        ...
        btnRegister.setOnClickListener {
            if (!hasNotificationPermission()) {
                ...
                lifecycleScope.launch {
                    ...
                    val email = emailInputFieldText.text.toString()
...
/*
// Activate only if server solution is needed
...
val url = "http://insert_IP_Address_here/sempertibi/insert_user.php"
...
val url = URL("http://Insert_here_IP_Address/sempertibi/getuserbymail.php")
